    ...
    return (
      <div className='ext-site-home-multiforum'>
        <section
          ...
          style={{
            backgroundImage: `url('/lib/frontend/site/home-multiforum/header-background.png')`
          }}>
          <div className='jumbotron_body'>
            <div className='container'>
              ...
              <p className='lead highlight bold'>
        ...
        <div className='section-icons col-md-8 offset-md-2 text-center'>
          <div className='row'>
            <div className='section-icon col-md-4'>
              <img
                className='icon'
                src='/lib/frontend/site/home-multiforum/icono_consulta-publica-1.png'
                alt='Informate'
              />
              <div className='text'>
                <h5>INFORMATE</h5>
            ...
            <div className='section-icon col-md-4'>
             <img
                className='icon'
                src='/lib/frontend/site/home-multiforum/icono_consulta-publica-2.png'
                alt='Participá'
              />
              <div className='text'>
                <h5>PARTICIPÁ</h5>
            ...
            <div className='section-icon col-md-4'>
             <img
                className='icon'
                src='/lib/frontend/site/home-multiforum/icono_consulta-publica-3.png'
                alt='Compartí'
              />
              <div className='text'>
                <h5>COMPARTÍ</h5>
        ...
        <div className='container forums-list' id='consultas'>
          <h2 className='forums-list-title uppercase'>CONSULTAS DISPONIBLES</h2>
